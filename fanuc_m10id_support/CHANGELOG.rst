^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package fanuc_m10id_support
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* add support for the M-10iD/12 variant (contributors: Jeremy Zoss (SwRI))
...
0.3.0 (2015-01-08)
------------------
* promote experimental packages for M-10iD, M-16iB, M-20iA, M-430iA and LR Mate 200iC to main repository.
